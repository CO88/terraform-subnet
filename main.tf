...
resource aws_route_table private {
  ...
  tags = {
    "Name" = format("%s-%s-%s", var.environment_name, var.name, element(var.azs, count.index))
  } 
}
...
# locals {
#   reuse_nat_ips is default false
